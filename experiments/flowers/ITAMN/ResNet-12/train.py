...
sys.path.append('../../../../')
from trainers import trainer, ITAM_train
from datasets import dataloaders
from models.ITAMN import ITAMN
...
fewshot_path = os.path.join(data_path,'flowers')
...
model = ITAMN(way=train_way,
            shots=[args.train_shot, args.train_query_shot],
            resnet=args.resnet)

train_func = partial(ITAM_train.default_train,train_loader=train_loader)
